...
class wpeologs_ctr {
	...
	public function render_add_submenu_page() {
		...
		require_once( wpeo_template_01::get_template_part( WPEO_TASK_LOGS_DIR, WPEO_TASK_LOGS_TEMPLATES_MAIN_DIR, 'backend', 'main' ) );
	}
	...
	public function admin_enqueue_scripts() {
		wp_register_script( 'wps_statistics_js_chart', WPEO_TASK_LOGS_URL . '/asset/js/chart.js');
