...
<div data-id="<?php echo $task->id; ?>" data-affected-id="<?php echo implode( ',', $task->option['user_info']['affected_id'] ); ?>" data-owner-id="<?php echo $task->option['user_info']['owner_id']; ?>" data-affected-tag-id="<?php echo implode( ',', !empty( $task->taxonomy['wpeo_tag'] ) ? $task->taxonomy['wpeo_tag'] : array() ); ?>" class="<?php echo !empty( $class ) ? $class : ''; ?> wpeo-project-task white">
