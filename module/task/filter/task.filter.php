...
class Task_Filter {
	...
	public function callback_dashboard_title( $string ) {
		...
		ob_start();
		View_Util::exec( 'task', 'backend/button-add', array( 'url' => $url ) );
		$string .= ob_get_clean();
	...
	public function callback_task_header_action( $string, $task ) {
		ob_start();
		View_Util::exec( 'task', 'backend/task-header-button', array( 'task' => $task ) );
		$string .= ob_get_clean();
		return $string;
	}
	...
	public function callback_task_header_information_elapsed( $string, $task ) {
		ob_start();
		View_Util::exec( 'task', 'backend/time-elapsed', array( 'task' => $task ) );
		$string .= ob_get_clean();
		return $string;
	}
	...
	public function callback_task_header_information_button( $string, $task ) {
		ob_start();
		View_Util::exec( 'task', 'backend/information-button', array( 'task' => $task ) );
		$string .= ob_get_clean();
		return $string;
	}
