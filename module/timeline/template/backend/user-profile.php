...
<table class="form-table">
	<tr>
		...
		<td>
			<input type="text" name="working_time" id="working-time" placeholder="02:30" value="<?php echo esc_attr( wpeo_util::convert_to_hours_minut( get_the_author_meta( 'working_time', $user->ID ) ) ); ?>" class="regular-text" /><br />
