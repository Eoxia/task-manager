...
class Tag_Filter {
	...
	public function callback_filter_dashboard_tabs( $current_tab_html ) {
		ob_start();
		\eoxia\View_Util::exec( 'tag', 'backend/filter-tab' );
	...
	public function callback_task_manager_dashboard_search( $current_search_html ) {
		...
		ob_start();
		\eoxia\View_Util::exec( 'tag', 'backend/filter-search', array( 'list_tag' => $list_tag ) );
	...
	public function callback_task_footer( $current_task_footer_html, $task ) {
		...
		ob_start();
		\eoxia\View_Util::exec( 'tag', 'backend/tags-wrapper', array( 'object' => $task, 'list_tag' => $list_tag ) );
