...
<ul class="wpeo-tag-wrap" data-nonce="<?php echo wp_create_nonce( 'ajax_view_all_tag_' . $object->id ); ?>" data-id="<?php echo !empty( $object ) ? $object->id : ''; ?>" data-listtagid="<?php echo ( !empty( $list_tag_id ) ) ? json_encode( $list_tag_id ) : ''; ?>">
	<?php
