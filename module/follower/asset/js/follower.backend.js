...
window.eoxiaJS.taskManager.follower.reloadViewProfileContract = function( element, response ){
	element.closest( '.planninguser' ).find( '.focus-element' ).removeClass( 'focus-element' ).addClass( 'button-bordered' );
	element.removeClass( 'button-bordered' ).addClass( 'focus-element' );
