...
<?php else: ?>
	<div class="wpeo-button button-red action-delete wpeo-tooltip-event"
		data-parent="tm-user-add-contract"
		data-action="delete_this_contract"
		data-nonce="<?php echo esc_attr( wp_create_nonce( 'delete_this_contract' ) ); ?>"
		data-message-delete="<?php echo esc_attr_e( 'Are you sur to delete this contract ?', 'task-manager' ); ?>"
		data-id="<?php echo esc_attr( $contract[ 'id' ] ); ?>"
		aria-label="<?php esc_html_e( 'Delete this contract', 'task-manager' ); ?>"
		style="margin-top: 10px; float: right;">
