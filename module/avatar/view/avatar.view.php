...
if ( ! empty( $users ) ) :
	foreach ( $users as $user ) :
		?>
		<div class="user tooltip hover" aria-label="<?php echo esc_attr( $user->data['displayname'] ); ?>" style="width: <?php echo esc_attr( $size ); ?>px; height: <?php echo esc_attr( $size ); ?>px;">
